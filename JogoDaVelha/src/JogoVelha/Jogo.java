...
public class Jogo {
    ...
    public void IniciarJogadores(){
        ...
        if(escolherJogador() == 1){
            this.jogador1 = new PlayerHumano(1);
        }
        else{
            this.jogador1 = new NPC(1);
        }
        ...
        if(escolherJogador() == 1){
            this.jogador2 = new PlayerHumano(2);
        }
        else{
            this.jogador2 = new NPC(2);
        }
    }
    ...
    public boolean Jogar(){
        if(ganhou() == 0 ){
            ...
            if(tabuleiro.tabuleiroCompleto()){
                System.out.println("Não há mais posições. JOGO EMPATADO");
                return false;
            }
            vez++;
            rodada++;
